      ...
      <div class="top-service-list">
        <section class="top-service-item">
          <div class="top-service-item-img">
            <img src="./assets/img/service1.png" alt="IT人材育成事業" />
          </div>
        ...
        <section class="top-service-item">
          <div class="top-service-item-img">
            <img src="./assets/img/service2.png" alt="コーチング事業" />
          </div>
        ...
        <section class="top-service-item">
          <div class="top-service-item-img">
            <img src="./assets/img/service3.png" alt="ITコンサル事業" />
          </div>
        ...
        <section class="top-service-item">
          <div class="top-service-item-img">
            <img src="./assets/img/service4.png" alt="デジタルトランスフォーメーション事業" />
          </div>
